...
derive_clique_reviewer_ids() {
  local bad_count="$1"
  local mode="${PEERTRUST_CLIQUE_REVIEWER_MODE:-all}"
...
"
  ...
  export TD_HS_REPUTATION_WINDOW_SIZE="${TD_HS_REPUTATION_WINDOW_SIZE:-256}"
  export TD_HS_REPUTATION_MIN_CANDIDATE_QCS="${TD_HS_REPUTATION_MIN_CANDIDATE_QCS:-64}"
  export TD_HS_REPUTATION_MIN_LEADER_OPPORTUNITIES=1
  export TD_HS_REPUTATION_DECAY_PER_EPOCH="${TD_HS_REPUTATION_DECAY_PER_EPOCH:-2}"
  export TD_HS_REPUTATION_PEERTRUST_DEBT_TRIGGER_SCORE="${TD_HS_REPUTATION_PEERTRUST_DEBT_TRIGGER_SCORE:-85}"
  export TD_HS_REPUTATION_PEERTRUST_DEBT_INCREMENT="${TD_HS_REPUTATION_PEERTRUST_DEBT_INCREMENT:-12}"
  export TD_HS_REPUTATION_PEERTRUST_DEBT_RECOVERY="${TD_HS_REPUTATION_PEERTRUST_DEBT_RECOVERY:-2}"
  export TD_HS_REPUTATION_PEERTRUST_DEBT_MAX="${TD_HS_REPUTATION_PEERTRUST_DEBT_MAX:-60}"
  export TD_HS_REPUTATION_PEERTRUST_SOFT_MIN_WEIGHT="${TD_HS_REPUTATION_PEERTRUST_SOFT_MIN_WEIGHT:-80}"
  export TD_HS_REPUTATION_AUDIT_JSONL_ENABLE=1
  export TD_HS_WEIGHT_UPDATE_EPOCH_VIEWS="${TD_HS_WEIGHT_UPDATE_EPOCH_VIEWS:-256}"
  ...
  export TD_HS_PEERTRUST_CLIQUE_START_VIEW="${TD_HS_PEERTRUST_CLIQUE_START_VIEW:-${TD_HS_SOFT_ATTACK_START_VIEW:-8192}}"
  ...
  unset TD_HS_PEERTRUST_CLIQUE_TARGET_IDS
  unset TD_HS_PEERTRUST_CLIQUE_REVIEWER_IDS
  unset TD_HS_PEERTRUST_CLIQUE_START_VIEW
