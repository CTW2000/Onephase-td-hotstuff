...
"
  ...
  export TD_HS_REPUTATION_PEERTRUST_DEBT_TRIGGER_SCORE="${TD_HS_REPUTATION_PEERTRUST_DEBT_TRIGGER_SCORE:-70}"
  export TD_HS_REPUTATION_PEERTRUST_DEBT_INCREMENT="${TD_HS_REPUTATION_PEERTRUST_DEBT_INCREMENT:-5}"
  export TD_HS_REPUTATION_PEERTRUST_DEBT_RECOVERY="${TD_HS_REPUTATION_PEERTRUST_DEBT_RECOVERY:-3}"
  export TD_HS_REPUTATION_PEERTRUST_DEBT_MAX="${TD_HS_REPUTATION_PEERTRUST_DEBT_MAX:-40}"
