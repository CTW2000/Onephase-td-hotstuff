...
clear_attack_env() {
  ...
  unset TD_HS_WEIGHT_UPDATE_VOTE_EQUIVOCATION_IDS TD_HS_TIMEOUT_VOTE_EQUIVOCATION_IDS
  unset TD_HS_INVALID_TC_PROPOSAL_IDS TD_HS_BAD_NODE_IDS TD_HS_BAD_NODE_COUNT
}
...
clear_pipeline_env() {
  ...
  unset TD_HS_INVALID_TC_PROPOSAL_DETECT_ENABLE TD_HS_CONFLICTING_QC_DETECT_ENABLE
  ...
  for ((attempt=1; attempt<=max_attempts; attempt++)); do
    ...
    for((i=1;;i++)); do
      ...
      env -u TD_HS_SILENT_LEADER_IDS -u TD_HS_SLOW_VOTE_IDS \
          ...
          -u TD_HS_TIMEOUT_VOTE_EQUIVOCATION_IDS -u TD_HS_INVALID_TC_PROPOSAL_IDS \
