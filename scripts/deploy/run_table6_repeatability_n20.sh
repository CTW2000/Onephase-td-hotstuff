...
configure_pipeline() {
  ...
  case "$experiment" in
    silent_leader)
      ...
      export TD_HS_REPUTATION_MAX_RECOVERY_PER_EPOCH="${TD_HS_REPUTATION_MAX_RECOVERY_PER_EPOCH:-2}"
      export TD_HS_REPUTATION_BONUS_PER_EPOCH="${TD_HS_REPUTATION_BONUS_PER_EPOCH:-1}"
