...
td_env_names=(
  ...
  TD_HS_SILENT_LEADER_START_VIEW
  TD_HS_SILENT_LEADER_MODE
  TD_HS_SILENT_ATTACK_HIGH
  TD_HS_SILENT_RETREAT_LOW
  TD_HS_SILENT_PERSIST_STOP
  TD_HS_SILENT_PROB_PERMILLE
  TD_HS_SILENT_BURST_ON
  TD_HS_SILENT_BURST_OFF
  TD_HS_SILENT_BAND_HI
  TD_HS_SILENT_BAND_LO
  TD_HS_SILENT_DEGRADE_STEP
  TD_HS_SLOW_VOTE_START_VIEW
  TD_HS_PEERTRUST_CLIQUE_START_VIEW
  TD_HS_PEERTRUST_CLIQUE_MODE
  TD_HS_PEERTRUST_CLIQUE_PROB_PERMILLE
  TD_HS_PEERTRUST_CLIQUE_BURST_ON
  TD_HS_PEERTRUST_CLIQUE_BURST_OFF
  TD_HS_PEERTRUST_CLIQUE_DEGRADE_STEP
  TD_HS_PEERTRUST_CLIQUE_PERSIST_STOP
  TD_HS_PEERTRUST_CLIQUE_ATTACK_HIGH
  TD_HS_PEERTRUST_CLIQUE_RETREAT_LOW
  TD_HS_PEERTRUST_CLIQUE_BAND_HI
  TD_HS_PEERTRUST_CLIQUE_BAND_LO
  TD_HS_STRONG_FAULT_ATTACK_START_VIEW
  TD_HS_STRONG_FAULT_ATTACK_WEIGHT
  TD_HS_DOUBLE_PROPOSAL_START_VIEW
  TD_HS_DOUBLE_VOTE_START_VIEW
  TD_HS_INVALID_QC_START_VIEW
  ...
  TD_HS_SLOW_VOTE_MODE
  TD_HS_SLOW_VOTE_PROB_PERMILLE
  TD_HS_SLOW_VOTE_WITHHOLD
  TD_HS_SLOW_VOTE_BURST_ON
  TD_HS_SLOW_VOTE_BURST_OFF
  TD_HS_SLOW_VOTE_DEGRADE_STEP
  TD_HS_SLOW_VOTE_PERSIST_STOP
  TD_HS_SLOW_VOTE_ATTACK_HIGH
  TD_HS_SLOW_VOTE_RETREAT_LOW
  TD_HS_SLOW_VOTE_BAND_HI
  TD_HS_SLOW_VOTE_BAND_LO
)
