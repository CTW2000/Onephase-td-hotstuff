...
env -u TD_HS_SILENT_LEADER_IDS \
    ...
    \
    \
    TD_HS_WEIGHT_UPDATE_VOTE_EQUIVOCATION_START_VIEW="${TD_HS_WEIGHT_UPDATE_VOTE_EQUIVOCATION_START_VIEW:-1024}" \
    TD_HS_TIMEOUT_EMPTY_PROPOSAL_VIEWS="${WEIGHT_UPDATE_VOTE_EQUIVOCATION_TIMEOUT_EMPTY_PROPOSAL_VIEWS:-512}" \
    TD_HS_REPUTATION_WINDOW_SIZE="${TD_HS_REPUTATION_WINDOW_SIZE:-1024}" \
    TD_HS_REPUTATION_MIN_CANDIDATE_QCS="${TD_HS_REPUTATION_MIN_CANDIDATE_QCS:-256}" \
